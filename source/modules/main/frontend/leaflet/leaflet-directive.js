(function() {
    ...
    angular.module("leaflet-directive", []).directive('leaflet', ["$log", "$q", "leafletData", "leafletMapDefaults", "leafletHelpers", "leafletEvents", function($log, $q, leafletData, leafletMapDefaults, leafletHelpers, leafletEvents) {
        return {
            restrict: "EA",
            replace: true,
            transclude: true,
    ...
    angular.module("leaflet-directive").directive('layers', ["$log", "$q", "leafletData", "leafletHelpers", "leafletMapDefaults", function($log, $q, leafletData, leafletHelpers, leafletMapDefaults) {
        var _leafletLayers;
    ...
    angular.module("leaflet-directive").directive('bounds', ["$log", "leafletHelpers", function($log, leafletHelpers) {
        return {
            restrict: "A",
            scope: false,
            replace: false,
            ...
            link: function(scope, element, attrs, controller) {
                ...
                controller.getMap().then(function(map) {
                    leafletScope.$watch('bounds', function(bounds) {
                        ...
                        new L.LatLng(southWest.lat, southWest.lng), new L.LatLng(northEast.lat, northEast.lng));
    ...
    angular.module("leaflet-directive").directive('markers', ["$log", "$rootScope", "$q", "leafletData", "leafletHelpers", "leafletMapDefaults", function($log, $rootScope, $q, leafletData, leafletHelpers, leafletMapDefaults) {
        return {
            restrict: "A",
            scope: false,
            replace: false,
                    ...
                    leafletMapDefaults.getDefaults(attrs.id).then(function(defaults) {
                        ...
                        getLayers().then(function(layers) {
                            ...
                            function createMarker(scope_watch_name, marker_data, map) {
                                ...
                                var availableMarkerEvents = ['click', 'dblclick', 'mousedown', 'mouseover', 'mouseout', 'contextmenu', 'dragstart', 'drag', 'dragend', 'move', 'remove', 'popupopen', 'popupclose'];
                                ...
                                if (leafletScope.eventBroadcast === undefined || leafletScope.eventBroadcast === null) {
                                    ...
                                    if (leafletScope.eventBroadcast.marker === undefined || leafletScope.eventBroadcast.marker === null) {
                                        ...
                                        // Enable / Disable
                                        var markerEventsEnable = false,
                                            markerEventsDisable = false;
                                            ...
                                            controller.getMap().then(function(map) {
                                                ...
                                                if (isObject(eventBroadcast)) {
                                                    ...
                                                    if (eventBroadcast.map === undefined || eventBroadcast.map === null) {
                                                        ...
                                                        // Enable / Disable
                                                        var mapEventsEnable = false,
                                                            mapEventsDisable = false;
                                ...
                                angular.module("leaflet-directive").directive('maxbounds', ["$log", "leafletMapDefaults", "leafletHelpers",
                                            ...
                                            controller.getMap().then(function(map) {
                                                leafletScope.$watch("maxBounds", function(maxBounds) {
                                                    if (isDefined(maxBounds.southWest) && isDefined(maxBounds.northEast) && isNumber(maxBounds.southWest.lat) && isNumber(maxBounds.southWest.lng) && isNumber(maxBounds.northEast.lat) && isNumber(maxBounds.northEast.lng)) {
                                                        map.setMaxBounds(
                                                        new L.LatLngBounds(
                                                        new L.LatLng(maxBounds.southWest.lat, maxBounds.southWest.lng), new L.LatLng(maxBounds.northEast.lat, maxBounds.northEast.lng)), maxBounds.options);
                                                    } else {
                                                        map.setMaxBounds();
                                                    }
                                                });
                                ...
                                angular.module("leaflet-directive").factory('leafletMapDefaults', ["$q", "leafletHelpers", function($q, leafletHelpers) {
                                    function _getDefaults() {
                                        return {
                                            ...
                                            icon: {
                                                url: '/styles/leaflet/marker-icon.png',
                                                retinaUrl: '/styles/leaflet/marker-icon-2x.png',
                                                size: [25, 41],
                                                anchor: [12, 40],
                                                labelAnchor: [10, -20],
                                                popup: [0, -40],
                                                shadow: {
                                                    url: '/styles/leaflet/marker-shadow.png',
                                                    retinaUrl: '/styles/leaflet/marker-shadow.png',
                                                    size: [41, 41],
                                                    anchor: [12, 40]
                                                }
                                            },
                                ...
                                angular.module("leaflet-directive").factory('leafletHelpers', ["$q", function($q) {
